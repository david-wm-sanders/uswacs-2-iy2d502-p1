...
\subsubsection{\todo{Cross-Site Request Forgery Protection}}
\todo{writeup how including the form.hidden\_tags() in the html jinja template will include the token provided automatically by FlaskForm}
